...
function Cart() {
  const { cart, clearCart, removeProductsByIds } = useContext(CartContext);
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "12px", marginTop: "24px" }}>
        <button
          style={{ minWidth: "120px", padding: "12px 20px", cursor: "pointer", backgroundColor: "#6c757d", color: "white", border: "none", borderRadius: "6px" }}
          onClick={() => navigate(-1)}
        >
          Go Back
        </button>
